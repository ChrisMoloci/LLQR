...
export const IMAGE_DEFAULTS = {
    ...
    FINDER_PATTERN_INNER_BACKGROUND_COLOR: "#FFFFFF",
    ...
    FINDER_PATTERN_OUTLINE_SHAPE: QRELEMENTSHAPES.CIRCLE,
    FINDER_PATTERN_INNER_BACKGROUND_SHAPE: QRELEMENTSHAPES.SQUARE,
    FINDER_PATTERN_INNER_SHAPE: QRELEMENTSHAPES.ROUNDED,
...
export const DEFAULT_IMAGE_SPECS: ImageSpecs = {
    ...
    finderPatternInnerBackgroundShape: IMAGE_DEFAULTS.FINDER_PATTERN_INNER_BACKGROUND_SHAPE,

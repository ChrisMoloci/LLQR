...
export const IMAGE_DEFAULTS = {
    ...
    MODULE_SHAPE: QR_ELEMENT_SHAPE.SQUARE,
    FINDER_PATTERN_OUTLINE_SHAPES: [QR_ELEMENT_SHAPE.SQUARE, QR_ELEMENT_SHAPE.SQUARE, QR_ELEMENT_SHAPE.SQUARE],
    FINDER_PATTERN_INNER_BACKGROUND_SHAPES: [QR_ELEMENT_SHAPE.SQUARE, QR_ELEMENT_SHAPE.SQUARE, QR_ELEMENT_SHAPE.SQUARE],
    FINDER_PATTERN_INNER_SHAPES: [QR_ELEMENT_SHAPE.SQUARE, QR_ELEMENT_SHAPE.SQUARE, QR_ELEMENT_SHAPE.SQUARE],
    ALIGNMENT_PATTERN_OUTLINE_SHAPES: QR_ELEMENT_SHAPE.SQUARE,
    ALIGNMENT_PATTERN_INNER_BACKGROUND_SHAPES: QR_ELEMENT_SHAPE.SQUARE,
    ALIGNMENT_PATTERN_INNER_SHAPES: QR_ELEMENT_SHAPE.SQUARE,

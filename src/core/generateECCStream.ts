...
function generateECCStream(encodedData: Array<string>, qrVersion: qrVersions, eccLevelCode: ECCLevelCode) {
    ...
    // -- 2. Split data into blocks and groups if applicable --

    // -- 3. Padd ECC 0 bytes for each block --

    // -- 4. Compute ECC for each block in each group --

    // -- 5. Interleave Stream

    // -- 6. Return ECC Stream as array of strings --
}

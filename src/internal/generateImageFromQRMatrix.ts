...
function generateImageFromQRMatrix(qrMatrix: Array<Array<number>>, imageSpecs: ImageSpecs | null = DEFAULT_IMAGE_SPECS): HTMLCanvasElement {
    const canvas: HTMLCanvasElement = generateImageCanvasFromMatrix(qrMatrix, imageSpecs || DEFAULT_IMAGE_SPECS, 512);
